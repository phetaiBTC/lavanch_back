export const generateHardDeleteUseCase = (moduleName: string, capitalize: (str: string) => string): string => {
...
@Injectable()
export class HardDelete${capitalizedName}UseCase {
  constructor(
  ...
  async execute(id: number[]): Promise<{ message: string }> {
    ...
    return await this.${moduleName}Repository.hardDelete(id);
  }
}
