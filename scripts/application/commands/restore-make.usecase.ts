export const generateRestoreUseCase = (moduleName: string, capitalize: (str: string) => string): string => {
...
@Injectable()
export class Restore${capitalizedName}UseCase {
  constructor(
  ...
  async execute(id: number[]): Promise<{ message: string }> {
    ...
    return await this.${moduleName}Repository.restore(id);
  }
}
